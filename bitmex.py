...
class MarketMaker( object ):
    ...
    def place_orders( self ):
        ...
        for fut in self.futures.keys():
            ...
            # Long position in neither skew
            if positionSkew == 'long' and (skewDirection == 'neither') and (overPosLimit == 'short' or overPosLimit == 'long') and positionGains[fut] == True :
                print(1)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
            ...
            elif positionSkew == 'long' and  ((skewDirection == 'neither' and (overPosLimit == 'short' or overPosLimit == 'long'))) and positionGains[fut] == False:

                print(2)
                if positionPrices[fut] != 0:
                    bbo     = self.getbidsandasks( fut, positionPrices[fut] )
                    bid_mkt = bbo[ 'bid' ]
                    ask_mkt = bbo[ 'ask' ]
                ##print(positionPrices[fut])
            ...
            # # profit or loss, at pos lim long
            ...
            elif positionSkew == 'long' and ((skewDirection == 'neither' and (overPosLimit == 'superlong' or overPosLimit == 'supershort'))):
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
                print(3)
                bbo     = self.get_bbo( fut )
                ...
                if overPosLimit == 'superlong' or overPosLimit == 'supershort':
            ...
            elif positionSkew == 'long' and (((skewDirection == 'long') ) and   place_bids2 == True) and positionGains[fut] == True:
                askMult = 1.25
                print(4)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, <50%
            elif positionSkew == 'long' and ( ((skewDirection == 'long' )) and (overPosLimit == 'neither')) and positionGains[fut] == False:
                print(5)
                if positionPrices[fut] != 0:
                    bbo     = self.getbidsandasks( fut, positionPrices[fut] )
                    bid_mkt = bbo[ 'bid' ]
            ...
            elif positionSkew == 'long' and ((skewDirection == 'long' or ( overPosLimit == 'long' or overPosLimit == 'short' ))) and positionGains[fut] == True:
                print(6)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, >50%
            elif positionSkew == 'long' and ( (skewDirection == 'long' or (overPosLimit == 'short' or overPosLimit == 'long'))) and positionGains[fut] == False:
                print(7)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            elif positionSkew == 'long' and ((skewDirection == 'superlong'  or (overPosLimit == 'superlong' or overPosLimit == 'supershort'))) and positionGains[fut] == True:
                print(8)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            elif positionSkew == 'long' and ((skewDirection == 'superlong'  or (overPosLimit == 'superlong' or overPosLimit == 'supershort'))) and positionGains[fut] == False:
                print('logic')
                print(9)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # in profit, <50% pos & skew
            elif positionSkew == 'long' and (((skewDirection == 'short'))) and overPosLimit == 'neither' and positionGains[fut] == True:
                bidMult = 1.25
                print(10)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, <50%
            elif positionSkew == 'long' and (((skewDirection == 'short'))) and overPosLimit == 'neither' and positionGains[fut] == False:
                print(11)
                if positionPrices[fut] != 0:
                    bbo     = self.getbidsandasks( fut, positionPrices[fut] )
                    bid_mkt = bbo[ 'bid' ]
           ...
           # # in profit, >50%
            ...
            elif positionSkew == 'long' and (( skewDirection == 'short' or ( overPosLimit == 'long' or overPosLimit == 'short' ))) and positionGains[fut] == True:
                print(12)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, >50%
            elif positionSkew == 'long' and ((skewDirection == 'short' or ( overPosLimit == 'long' or overPosLimit == 'short' ))) and positionGains[fut] == False:
                print(13)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # in profit, 100% pos or skew
            elif positionSkew == 'long' and skewDirection == 'supershort' or ((overPosLimit == 'superlong' or overPosLimit == 'superhort')) and positionGains[fut] == True:
                print(14)
                place_asks = 0
                asks = 0
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                ...
                if True :
                    ...
                    ask_ords = []
            # # at a loss, 100% pos or skew
            elif positionSkew == 'long' and (skewDirection == 'supershort' or (overPosLimit == 'superlong' or overPosLimit == 'supershort')) and positionGains[fut] == False:
                print(15)
                place_asks = 0
                asks = 0
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                ...
                if place_bids == False:
                    nbids = 0
                    place_bids = 0
                if overPosLimit == 'short' or overPosLimit == 'supershort' or overPosLimit == 'long' or overPosLimit == 'superlong':
                    if True :
            ...
            elif positionSkew == 'short' and skewDirection == 'neither' and (overPosLimit == 'short' or overPosLimit == 'long') and positionGains[fut] == True :
                print(16)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            elif positionSkew == 'short' and skewDirection == 'neither' and (overPosLimit == 'short' or overPosLimit == 'long') and positionGains[fut] == False :
                print(17)
            ...
            elif positionSkew == 'short' and skewDirection == 'neither' and (( (overPosLimit == 'superlong' or overPosLimit == 'supershort') ) or (skewDirection == 'long' or skewDirection == 'short' and (overPosLimit == 'superlong' or overPosLimit == 'supershort'))):
                print(18)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # in profit, <50% pos & skew
            elif positionSkew == 'short' and ( ((skewDirection == 'long') or (skewDirection == 'long' )) and  place_asks2 == True) and positionGains[fut] == True:
                print(19)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, <50%
            elif positionSkew == 'short' and ( ((skewDirection == 'long') or (skewDirection == 'long' )) and  place_asks2 == True) and positionGains[fut] == False:
                print(20)
                if positionPrices[fut] != 0:
                    bbo     = self.getbidsandasks( fut, positionPrices[fut] )
                    bid_mkt = bbo[ 'bid' ]
            ...
            elif positionSkew == 'short' and ( (skewDirection == 'long' or (overPosLimit == 'long' or overPosLimit == 'short')) and  place_asks2 == False) and positionGains[fut] == True:
                print(21)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, >50%
            elif positionSkew == 'short' and (  (skewDirection == 'long'  or (overPosLimit == 'long' or overPosLimit == 'short')) ) and positionGains[fut] == False:
                print(22)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # in profit, 100% pos or skew
            elif positionSkew == 'short' and ((skewDirection == 'superlong' or overPosLimit == 'superlong' or overPosLimit == 'supershort')) and positionGains[fut] == True:
                print(23)
                nbids = 0
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, 100% pos or skew
            elif positionSkew == 'short' and (skewDirection == 'superlong'  or overPosLimit == 'superlong' or overPosLimit == 'supershort') and positionGains[fut] == False:
                print(24)
                nbids = 0
                place_bids = 0
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                ...
                #nasks = 0
                #place_asks = 0
                if overPosLimit == 'supershort' or overPosLimit == 'superlong' or overPosLimit == 'supershort':
                    if True :
            ...
            # # in profit, <50% pos & skew
            elif positionSkew == 'short' and ( (( skewDirection == 'short') ) and  place_asks2 == True) and positionGains[fut] == True:
                print(25)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, <50%
            elif positionSkew == 'short' and ( (( skewDirection == 'short') ) and  place_asks2 == True) and positionGains[fut] == False:
                print(26)
                if positionPrices[fut] != 0:
                    bbo     = self.getbidsandasks( fut, positionPrices[fut] )
                    bid_mkt = bbo[ 'bid' ]
            ...
            elif positionSkew == 'short' and ( ( skewDirection == 'short' or (overPosLimit == 'long' or overPosLimit == 'short')) and  place_asks2 == False) and positionGains[fut] == True:
                print(27)
                bidMult = 1.25
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # at a loss, >50%
            elif positionSkew == 'short' and ( ( skewDirection == 'short' or (overPosLimit == 'long' or overPosLimit == 'short')) and  place_asks2 == False) and positionGains[fut] == False:
                print(28)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
            ...
            # # in profit, 100% pos or skew
            elif positionSkew == 'short' and (( skewDirection == 'supershort' or (overPosLimit == 'superlong' or overPosLimit == 'supershort'))) and positionGains[fut] == True:
                print(29)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
                ...
                if True :
                    ...
                    ask_ords = []
            # # at a loss, 100% pos or skew
            elif positionSkew == 'short' and (( skewDirection == 'supershort' or (overPosLimit == 'superlong' or overPosLimit == 'supershort'))) and positionGains[fut] == False:
                print(30)
                eps         = BP * vol * (RISK_CHARGE_VOL * ((self.predict_1 * self.predict_5) + 1))
                riskfac     = math.exp( eps )
