...
class MarketMaker( object ):
  ...
  "params": {
    ...
    def output_status( self ):
        ...
        print   (    'Lev max short BTC: ' + str(round(self.LEV_LIM_SHORT['BTC'] * 1000) / 1000) + ' and long: ' + str(round(self.LEV_LIM_LONG['BTC'] / self.LEV * 1000) / 1000) + ' and percent of BTC in position out of max for short, then long: ' + str(round(self.LEV_LIM_SHORT['BTC'] / self.LEV * 1000) / 10) + '%, ' + str(round(self.LEV_LIM_LONG['BTC'] / self.LEV * 1000) / 10) + '%') 
        print   (    'Lev max short ETH: ' + str(round(self.LEV_LIM_SHORT['ETH'] * 1000) / 1000) + ' and long: ' + str(round(self.LEV_LIM_LONG['ETH'] / self.LEV * 1000) / 1000) + ' and percent of ETH in position out of max for short, then long: ' + str(round(self.LEV_LIM_SHORT['ETH'] / self.LEV * 1000) / 10) + '%, ' + str(round(self.LEV_LIM_LONG['ETH'] / self.LEV * 1000) / 10) + '%') 
        string = "\n"
